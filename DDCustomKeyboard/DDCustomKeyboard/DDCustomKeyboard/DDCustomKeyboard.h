...
//! Project version number for DDCustomKeyboard.
FOUNDATION_EXPORT double DDCustomKeyboardVersionNumber;

//! Project version string for DDCustomKeyboard.
FOUNDATION_EXPORT const unsigned char DDCustomKeyboardVersionString[];

@class DDCustomKeyboard;

/**
 *  The @c DDCustomKeyboardDelegate protocol defines the messages sent to a delegate object as part of the sequence of editing text. All of the methods of this protocol are optional.
 */
@protocol DDCustomKeyboardDelegate <NSObject>
@optional
 ...
 */
- (BOOL)numberKeyboard:(DDCustomKeyboard *)numberKeyboard shouldInsertText:(NSString *)text;
 ...
 */
- (BOOL)numberKeyboardShouldDeleteBackward:(DDCustomKeyboard *)numberKeyboard;
 ...
 */
@property (weak, nonatomic) id <DDCustomKeyboardDelegate> delegate;
 ...
 *
 *  @note The default value of this property is @c DDCustomKeyboardButtonStyleDone.
 */
@property (assign, nonatomic) DDCustomKeyboardButtonStyle returnKeyButtonStyle;
