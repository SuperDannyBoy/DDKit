...
// 边框颜色
#define kBorderColor [UIColor colorWithRed:((float)((0xE1E2E3 & 0xFF0000) >> 16))/255.0 green:((float)((0xE1E2E3 & 0xFF00) >> 8))/255.0 blue:((float)(0xE1E2E3 & 0xFF))/255.0 alpha:1.0]
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        _tableView.separatorColor  = UIColorFromHex(0xE1E2E3);
